export const en = {
  navbar: {
    ...
    subtitle: "Give Justice, Change Bihar",
    home: "Home",
    about: "Who was Bharat Tiwari?",
    demands: "Our Demands",
    support: "Give Public Support"
  },
  hero: {
    quote: '"The sword of revolution is sharpened on the whetstone of ideas."',
    author: "- Bhagat Singh",
    preTitle: "Give Justice,",
    mainTitle: "Change Bihar!",
    subtitle: "Raise your voice against injustice, change the system, so that no other Bharat Tiwari has to pick up weapons.",
    readDemands: "Read Our Demands",
    support: "Give Public Support",
    education: "Education",
    eduSub: "Every child's right",
    health: "Health",
    healthSub: "Every citizen's right",
    security: "Security",
    secSub: "Every woman's right",
    respect: "Respect",
  ...
  about: {
    ...
    intro: "Bharat Bhushan Tiwari was a social worker from Bilauti village in Bhojpur (Ara) district, Bihar, who died during a police encounter in June 2026. Following his death, a massive political and social uproar has erupted across Bihar.",
    card1: {
      title: "Social Background & Activism",
      item1: "Social Background: Locals knew him as a social worker. He was active in helping flood victims and raising public issues before the authorities.",
      item2: "Social Media Activism: He made several posts against the system on social media and warned corrupt officials."
    },
    card2: {
      title: "The Encounter Case",
      item1: "Police's Stance: According to the police, he possessed illegal weapons. Firing allegedly occurred during interrogation, to which police retaliated.",
      item2: "Family & Villagers' Allegations: The family alleges it was a fake encounter. According to a viral video, he surrendered by throwing his pistol, yet was intentionally shot."
    },
    card3: {
      title: "Current Status & Legal Action",
      item1: "Judicial Probe: Viewing the public outrage, the Bihar government ordered a judicial probe by a retired High Court judge.",
      item2: "Action on Police: Four policemen, including the Shahpur SHO, have been suspended.",
      item3: "Case in Supreme Court: A PIL has been filed in the Supreme Court demanding an independent panel and CBI probe."
    }
  },
  demands: {
  ...
  detailedDemand: {
    ...
    c1: {
      ...
      i2: "Alternative housing arrangements must be ensured first.",
      i3: "Rehabilitation policy should be legally binding.",
      i4: "Consent and dignity of affected families should be respected."
    },
    c2: {
      title: "Permanent Solutions for Flood-Affected Areas",
      i1: "Create a long-term plan for river erosion and flood control.",
      i2: "Scientific management of embankments, drainage, and ponds.",
      i3: "Permanent housing and infrastructure at rehabilitation sites.",
      i4: "Permanent and sustainable solutions instead of temporary yearly fixes."
    },
    c3: {
      title: "Complete Transparency in Disaster Relief Funds",
      i1: "How much came, where was it spent – details on a public portal.",
      i2: "Disclosure of fund utilization down to the Gram Panchayat level.",
      i3: "Social auditing made mandatory.",
      i4: "Immediate FIRs and recovery for fraud and scams."
    },
    c4: {
      title: "Strict Monitoring of Yearly Fund Misuse",
      i1: "High-level probe into the yearly expenses made in the name of floods.",
      i2: "Responsible officials should be held accountable and strictly punished.",
      i3: "Helpline and complaint portal for public monitoring.",
      i4: "Dismissal from service and property confiscation if found guilty."
    }
  },
  cta: {
    text: "We want a Bihar where youth get education, opportunities, and justice, not weapons. Where women get security, not fear. And where every family has the right to live with dignity.",
    supportBtn: "Give Public Support",
    subtext: "Your support is the beginning of change."
  },
  footer: {
    stat1: "People supported",
    stat2: "Villages connected",
    stat3: "Organizations joined",
    stat4: "Districts campaigning",
    social: "Follow us on social media"
  },
  form: {
    title: "Public Support Form",
    fullName: "Full Name",
    ...
    success: "Your support has been recorded. Thank you!",
